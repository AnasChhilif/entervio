  ...
  return (
    <div className="min-h-screen bg-background text-foreground font-sans selection:bg-secondary/30">
      ...
      <main className="pt-16">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-secondary/60 border border-border shadow-sm">
                ...
                <span className="text-sm font-medium text-foreground">Bientôt disponible</span>
              </div>
              ...
              <p className="text-xl md:text-2xl text-muted-foreground max-w-xl leading-relaxed font-light">
                Maîtrisez vos entretiens, créez le CV parfait, et trouvez votre prochaine opportunité. Tout en un seul
                endroit.
              </p>
                ...
                <Card className="border-border shadow-[var(--shadow-diffuse)] bg-card hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
                  <CardContent className="p-8 flex items-center gap-6">
                    ...
                    <div className="flex-1">
                      ...
                      <h3 className="text-2xl font-serif font-medium text-foreground mt-1">IA Adaptative</h3>
                ...
                <div className="grid grid-cols-2 gap-6">
                  <Card className="border-border shadow-sm bg-card hover:shadow-md transition-all duration-300 hover:-translate-y-1">
                    <CardContent className="p-6">
                      ...
                      <h4 className="text-lg font-serif font-medium text-foreground mb-1">CV Parfait</h4>
                      <p className="text-sm text-muted-foreground">Générateur professionnel</p>
                    </CardContent>
                  </Card>
                  <Card className="border-border shadow-sm bg-card hover:shadow-md transition-all duration-300 hover:-translate-y-1">
                    <CardContent className="p-6">
                      ...
                      <h4 className="text-lg font-serif font-medium text-foreground mb-1">Recherche Intelligente</h4>
                      <p className="text-sm text-muted-foreground">Offres personnalisées</p>
                    </CardContent>
                  </Card>
                </div>
              </div>
        ...
        <section id="features" className="container mx-auto px-6 py-24 max-w-7xl">
          <div className="text-center mb-16 animate-on-scroll">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-card border border-border shadow-sm mb-4">
              ...
              <span className="text-sm font-medium text-muted-foreground">Plateforme Complète</span>
            </div>
            ...
            {[
              ...
              >
                <CardHeader>
                  ...
                  <CardDescription className="text-base leading-relaxed mt-2">{feature.desc}</CardDescription>
                </CardHeader>
              </Card>
            ))}
          </div>
          ...
          <div className="container mx-auto px-6 max-w-7xl">
            ...
            <div className="grid md:grid-cols-4 gap-8">
              {[
                ...
                <div key={i} className="relative animate-on-scroll h-full" style={{ animationDelay: `${i * 150}ms` }}>
                  {i < 3 && <div className="hidden md:block absolute top-12 left-1/2 w-full h-0.5 bg-border -z-10" />}
        ...
        <section id="waitlist" className="container mx-auto px-6 py-24 max-w-7xl">
            ...
            <CardContent className="p-12 md:p-16 text-center">
              <div className="max-w-2xl mx-auto">
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-secondary/60 border border-border mb-6">
                  ...
                  <span className="text-sm font-medium text-foreground">Accès Anticipé</span>
                </div>
      ...
      <footer className="border-t border-border bg-background/50 backdrop-blur-sm">
        <div className="container mx-auto px-6 py-6">
          <div className="flex flex-col items-center gap-2 text-center">
            <div className="text-sm text-muted-foreground">Créé avec ❤️ par l'équipe Entervio</div>
            <div className="text-xs text-muted-foreground/60">© 2025 Entervio. Tous droits réservés.</div>
          </div>
        </div>
      </footer>
    </div>
