...
Revision ID: b6f733d343a6
Revises: ca2f914fd931
Create Date: 2025-12-12 13:58:06.103210
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "interviewer_style",
            sa.Enum("NICE", "NEUTRAL", "MEAN", name="interviewerstyle"),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("ix_work_experiences_id"), "work_experiences", ["id"], unique=False
    )
