...
import {
  ...
  DatePicker,
  Section,
} from "~/components/resume/ResumeFormComponents";
        ...
        <div className="space-y-8">
          ...
          >
            {resume.work_experiences.map((item, idx) => (
              <Card
                key={idx}
                className="border border-border/40 shadow-none bg-card/50"
              >
                <CardContent className="p-6 space-y-5">
                    ...
                    <div className="flex-1 space-y-5">
                      ...
                      <div className="grid grid-cols-2 gap-5">
                        ...
                        <DatePicker
                          value={item.end_date}
                          onChange={(val) =>
                            updateItem("work_experiences", idx, "end_date", val)
                          }
                          placeholder="Fin"
                        />
                      </div>
                    ...
                    <div className="flex-1 space-y-5">
                      ...
                      <div className="grid grid-cols-2 gap-5">
                        <DatePicker
                          value={item.start_date}
                          onChange={(val) =>
                            updateItem("educations", idx, "start_date", val)
                          }
                          placeholder="Début"
                        />
                        <DatePicker
                          value={item.end_date}
                          onChange={(val) =>
                            updateItem("educations", idx, "end_date", val)
                          }
                          placeholder="Fin"
                        />
                      </div>
                    ...
                    <div className="flex-1 space-y-5">
                      <div className="grid md:grid-cols-2 gap-5">
                        <Input
                          value={item.name}
                          onChange={(e) =>
                            updateItem("projects", idx, "name", e.target.value)
                          }
                        ...
                        <Input
                          value={item.role || ""}
                          onChange={(e) =>
                            updateItem("projects", idx, "role", e.target.value)
                          }
                          placeholder="Rôle"
                        />
                      </div>
                      <Input
                        ...
                        placeholder="Stack technique (ex: React, Python, AWS)"
                      />
                      <div className="grid grid-cols-2 gap-5">
                        <DatePicker
                          value={item.start_date}
                          onChange={(val) =>
                            updateItem("projects", idx, "start_date", val)
                          }
                          placeholder="Début"
                        />
                        <DatePicker
                          value={item.end_date}
                          onChange={(val) =>
                            updateItem("projects", idx, "end_date", val)
                          }
                          placeholder="Fin"
                        />
                      </div>
              ...
              {resume.skills.map((item, idx) => (
                <div key={idx} className="flex gap-3 items-center">
                  <Input
                    ...
                    value={item.name}
                    onChange={(e) =>
                      updateItem("skills", idx, "name", e.target.value)
                    }
                  ...
                  <Input
                    ...
                    value={item.category || ""}
                    onChange={(e) =>
                      updateItem("skills", idx, "category", e.target.value)
                    }
              ...
              {resume.languages.map((item, idx) => (
                <div key={idx} className="flex gap-3 items-center">
                  <Input
                    ...
                    value={item.name}
                    onChange={(e) =>
                      updateItem("languages", idx, "name", e.target.value)
                    }
                    placeholder="Langue"
                  />
                  <Input
